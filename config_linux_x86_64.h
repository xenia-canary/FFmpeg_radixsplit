...
#define FFMPEG_CONFIGURATION "--cc=clang-9 --arch=x86_64 --disable-everything --disable-programs --disable-all --disable-x86asm --disable-autodetect --disable-network --enable-avcodec --enable-avformat --enable-avutil --enable-decoder=xmaframes --enable-decoder=wmav2 --enable-demuxer=asf --enable-protocol=file"
